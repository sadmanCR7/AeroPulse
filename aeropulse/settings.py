"""
Django settings for aeropulse project.
...
SECRET_KEY = 'django-insecure-bz^^1g)la*c95c2sk9vy_$3v1k%f^6g_#30g^iqma-d5mj=1_f'
...
ROOT_URLCONF = 'aeropulse.urls'

# In AeroPulse/aeropulse/settings.py
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',  # I've added this line
                'django.template.context_processors.request',
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages',
                'flight_management.context_processors.notifications_processor',

            ],
        },
    },
]
WSGI_APPLICATION = 'aeropulse.wsgi.application'
